...
export default function App() {
  ...
  const [age, setAge] = useState<AgeMode>(() => load('ageMode', 'trail' as AgeMode));
  const [settings, setSettings] = useState<ElectionSettings>(() => load('settings', { ...defaultSettings, issueCount: ageRanges.trail.defaultIssueCount }));
